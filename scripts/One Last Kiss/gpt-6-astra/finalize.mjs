...
const dir = resolve(root, ".work/One Last Kiss/gpt-6-astra");
await mkdir(dir, { recursive: true });
const output = resolve(root, "out/One Last Kiss（GPT-6 Astra）.mp4");
const check = (file) =>
  JSON.parse(
    execFileSync(
      resolve(root, ".venv/bin/python"),
      [
        resolve(root, "scripts/One Last Kiss/gpt-6-astra/verify-audio.py"),
        file,
      ],
      { encoding: "utf8" },
    ),
