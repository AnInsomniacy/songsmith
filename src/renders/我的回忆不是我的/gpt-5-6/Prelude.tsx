...
import { FONT_IMPACT, FONT_MEMORY, FONT_UTILITY } from "./typography";
...
const CreditLine: React.FC<{
  ...
  const inTerm = (index: number, term: string) => {
    ...
    const unitEnd = unitStart + line.units[index].text.length;
