...
import { C, smooth, turn, wave, type Shot } from "../design";
...
export const Materials: React.FC<{
  ...
  <defs>
    <linearGradient id={`${id}-metal-line`} gradientUnits="userSpaceOnUse" x1="0" y1="0" x2="170" y2="70" spreadMethod="reflect">
      <stop stopColor="#68838B"/><stop offset=".45" stopColor="#D9E0CF"/><stop offset="1" stopColor="#779397"/>
    </linearGradient>
    <linearGradient id={`${id}-wood-line`} gradientUnits="userSpaceOnUse" x1="0" y1="0" x2="130" y2="50" spreadMethod="reflect">
      <stop stopColor="#936D46"/><stop offset=".5" stopColor="#D0A578"/><stop offset="1" stopColor="#876142"/>
    </linearGradient>
